...
build_ffmpeg() {
    ...
    ./configure --disable-debug \
        ...
        --extra-ldflags="-L${PREFIX}/lib -L/usr/local/cuda/lib64 -L/usr/local/cuda/lib32/ -L/usr/local/cuda/targets/x86_64-linux/lib -L/usr/local/cuda/targets/sbsa-linux/lib -L/usr/lib/x86_64-linux-gnu -L/usr/lib/aarch64-linux-gnu -L/usr/lib" \
